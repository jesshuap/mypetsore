...
public class ContainerEnvironment implements Serializable {
	...
	@Value("${petstore.service.persistOrder.url:}")
	private String petStorePersistOrderServiceURL;
	...
	public String getPetStorePersistOrderServiceURL() {
		return petStorePersistOrderServiceURL;
	}
